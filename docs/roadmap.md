...
- **В работе — одна задача**, на неделю — две-три. Остальное лежит в бэклоге и не давит.
...
- **Отстаёшь от сроков** — выкидывай хардкор, но не демо. Сроки — ориентир, а не дедлайн.
